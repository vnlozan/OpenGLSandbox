...
_VertexBuffer::_VertexBuffer( const void* data, unsigned int size ): m_Stride{ 0 } {
...
void _VertexBuffer::AddLayoutElement( unsigned int glType, unsigned int count, unsigned int normalized, bool isInstanced, unsigned int divisor ) {
